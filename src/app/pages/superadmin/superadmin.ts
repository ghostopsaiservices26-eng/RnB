...
@Component({
  ...
  styles: [`
    ...
    .tag-item { display: flex; align-items: center; gap: 6px; padding: 4px 10px; background: rgba(44,74,62,0.08); border-radius: 100px; font-size: 0.8rem; color: #2C4A3E; font-weight: 500; }
    .tag-item button { background: none; border: none; color: #7A7167; cursor: pointer; font-size: 1rem; line-height: 1; padding: 0; }
